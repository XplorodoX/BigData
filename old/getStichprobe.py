...
# Wie viele Wettbewerbe wir abfragen wollen
num_competitions = 10
...
# Wettbewerbe abrufen (nach Enddatum sortiert) und auf x Competitions beschränken
competitions = api.competitions_list(sort_by='recentlyCreated')
competitions = competitions[:num_competitions]
...
if not competitions:
    ...
    for competition in competitions:
        # Slug extrahieren (falls ref eine komplette URL enthält)
        comp_slug = competition.ref.split("/")[-1]
